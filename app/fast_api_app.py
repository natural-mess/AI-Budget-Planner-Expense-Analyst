...
app = FastAPI(
    ...
    description="API for interacting with the Agent ai-budget-planner",
    lifespan=lifespan,
)
...
async def chat_api(req: ChatRequest):
    ...
    if req.model:
        adk_app.root_agent.model.model = req.model
        
    content = genai_types.Content(parts=[genai_types.Part.from_text(text=req.message)])
